...
function descending(comparator){
    ...
    return function(record1, record2) {
        //... negate results of the comparator()
...
function pluck(propName) {
    //return a transformer that does...
    return function(record) {
        //..returns just the requesed property
...
function max(n1, n2) {
    //ternary condition -- look at intro to js tutorial for more
    return n2 > n1 ? n2 : n1;
}
//reduce funtion(what is used, what is comparing to)
